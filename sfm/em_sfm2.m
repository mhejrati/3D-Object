function [P3, S_bar, V, RO, Tr, Z, sigma_sq, phi, Q, mu0, sigma0] = em_sfm2(P, MD, K, use_lds, tol, max_em_iter,V,S_bar)
...
%[R_init, Trvect, dumS_bar] = rigidfac_knownshape(P_hat, MD,S_bar);
[R_init, Trvect] = rigidfac_knownshape(P_hat, MD,S_bar);
...
[dumV, Z] = init_SB(P_hat, Tr, R, S_bar, K);
...
for em_iter=1:max_em_iter,   
   ...
   % updates shape basis
   %[S_bar, V] = mstep_update_shapebasis2(P_hat, E_z, E_zz, R, Tr, S_bar, V,train_ids);   % (Eq 21)
